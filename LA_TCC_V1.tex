...
%	\addcontentsline{toc}{chapter}{Introdução}
	...
	\par Cada camada OSI contém um conjunto de funções executadas por programas para fazer os dados viajarem de uma origem até o destino de uma rede. Tanenbaum \& Wetherall (2011) discorrem sobre as camadas de maneira detalhada:
	...
	\par Existem três diferentes formas de compartilhamento de mensagens, chamados de \textit{Unicast}, \textit{Multicast} e Broadcast. Forouzan (2007) e Tanenbaum \& Wetherall (2011) descrevem técnicas específicas para o envio da informação de acordo com cada possível cenário.
