...
%	\addcontentsline{toc}{chapter}{Introdução}
	...
	\par Quando um pacote WSMP ou IPv6 chega na subcamada MAC, tendo o roteamento do canal apropriadamente finalizado, esta deverá “enfileirar” os dados de acordo com a categoria de acesso indicada (valores entre 1 e 4). A \autoref{fig_26} ilustra as filas e o roteamento do canal. O mapeamento dos pacotes atribuindo o indicador de prioridade é tratado pelo padrão IEEE 802.11. Os Provedores de Serviço WAVE podem opcionalmente anunciar parâmetros EDCA via anúncio de serviços WAVE. Caso nenhum parâmetro EDCA seja especificado, o EDCA padrão é ativado.
	...
	\begin{description}
		...
		\begin{itemize}
			\item Um dispositivo WAVE configurado para monitorar anúncios de serviços WAVE (WSAs) no canal de controle. Quando o canal de controle recebe um WSA de seu interesse, o dispositivo o alterna para o canal de serviço durante do intervalo de tempo 1 para participar da aplicação de interesse, retornando ao canal de controle durante intervalo de tempo 0 para monitoramento de outros WSAs ou qualquer outra atividade. Alternativamente, um dispositivo pode ser configurado para alternar entre canais de serviço também.
		\end{itemize}
		
		\item[(C)] Acesso imeditado: o acesso é mudado por tempo determinado ou indefinido;
		\begin{itemize}
			\item Um dispositivo é configurado para monitorar um canal de controle. Ao receber um WSA com uma aplicação de interesse, o dispositivo alterna imediatamente para um canal de serviço por um tempo específico a fim de completar determinada atividade. Ao término desta atividade, o dispositivo retorna ao primeiro canal.
		\end{itemize}		
	\end{description}
