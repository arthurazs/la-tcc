...
%	\addcontentsline{toc}{chapter}{Introdução}
	...
	\par A \autoref{fig_26} ilustra as filas e o roteamento do canal. O mapeamento dos pacotes atribuindo o indicador de prioridade é tratado pelo padrão IEEE 802.11. Os Provedores de Serviço WAVE podem opcionalmente anunciar parâmetros EDCA via anúncio de serviços WAVE. Caso nenhum parâmetro EDCA seja especificado, o EDCA padrão é ativado.
	...
	\par Além dos serviços de gerenciamento MLME mencionados no padrão 802.11 para redes sem fio em geral, o padrão WAVE IEEE 1609.4 adiciona novos serviços necessários à tecnologia de redes veiculares. Os serviços oferecidos no plano de gerenciamento da subcamada MAC WAVE são:		
	...
	\par A MLME permite \textbf{outros serviços} inclusos no padrão IEEE 802.11 possam chamados por cada canal independentemente.
	...
	\subsubsection{Anúncio de Serviços WAVE}
