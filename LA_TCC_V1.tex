...
% ----------------------------------------------------------
	...
	\par Semáforos inteligentes podem ser controlados para a liberação de vias de acordo com o tráfego. É possível desenvolver aplicações para comunicação entre veículos de segurança pública e semáforos para que haja uma mudança no sincronismo dos sinais garantindo fluxo livre perto da aproximação destes veículos.
